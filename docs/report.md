...
I parametri di training configurabili sono quindi tre — `inner_steps_H`, `batch_size`, e il numero di round $R$ determinato dall'early stopping — e le epoche emergono come conseguenza derivata, non come input:
