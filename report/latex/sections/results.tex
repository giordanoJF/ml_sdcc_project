...
del fanout, isolando l'effetto congiunto di scala e grado di connettività — il
...
(fanout minimo) con $k=N-1$ (broadcast completo a singolo hop). L'accuratezza di
...
Ogni messaggio push trasporta l'intero \texttt{state\_dict} del modello
...
funzione di $H$, la Fase C (invio push) resta sotto i 340\,ms anche con
