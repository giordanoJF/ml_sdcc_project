...
\begin{figure}[t]
  ...
  di chi riceve (Sezione~\ref{sec:background}D). Il riquadro tratteggiato
...
discovery server una sola volta, all'avvio (Sezione~\ref{sec:details}B), e
...
(Sezione~\ref{sec:background}D). La cache
